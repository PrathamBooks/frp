var AdminGraphs = function(user_data, campaign_data, donation_data) {
  ...
  this.user_graph = function(user_data, $div) {
    ...
    var cur_date_index;
    var i;
    for (i = 0, cur_date_index = 0; i < user_data.length; i++) {
      var cur_user = user_data[i];
    ...
    for (i = 1; i < dates.length; i++) {
      ...
      dates[i][1] = dates[i][1].getDate() + dates[i - 1][1];
    }
