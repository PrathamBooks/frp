...
class Campaign(BaseMixin, db.Model):
    ...
    description = db.Column(db.Unicode(1000), nullable=False)
    who = db.Column(db.Unicode(2000), nullable=False)
    impact = db.Column(db.Unicode(2500), nullable=False)
    total_impact_on_children = db.Column(db.Integer, nullable=True)
    utilization = db.Column(db.Unicode(2000), nullable=False)
